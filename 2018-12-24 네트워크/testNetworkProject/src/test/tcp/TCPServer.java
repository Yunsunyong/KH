...
public class TCPServer {
	...
	public static void serverStart() {
		// 1. port 번호 정하기
		int port = 7777; // 2000번 이후의 번호는 아무거나 해도 됨
		...
		try {
			...
			while(true) { //언제 올지 몰라서 무한루프돌임
				...
				//네트워크입출력은 바이트입출력이 기본
				InputStream is = client.getInputStream(); //inputStream 정보 얻음
				OutputStream os = client.getOutputStream(); //outputStream 정보 얻음
